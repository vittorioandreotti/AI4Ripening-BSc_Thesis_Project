function [MOVINGREG, p] = registerImages(MOVING,FIXED)
...
% Auto-generated by registrationEstimator app on 26-Jan-2021
%-----------------------------------------------------------
...
%Salvataggio parametri per elaborazioni successive
p.tform = tform;
p.movRefObj = movingRefObj;
p.fixRefObj = fixedRefObj;
p.val = true;
